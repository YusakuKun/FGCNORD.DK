  ...
  return (
    ...
    >
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mt-5 inline-flex items-center justify-center gap-2 rounded-full border-[3px] border-ink bg-ink px-5 py-2.5 pt-3 text-[15px] font-semibold uppercase tracking-[0.02em] text-cream shadow-poster-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-brick hover:text-ink hover:shadow-poster"
      >
